...
http_archive(
    ...
    sha256 = "9dbb2adb97e1afd27b34f008c2b9d20d664096a14a36d72278eb08604be268cb",
    strip_prefix = "gh_2.59.0_macOS_arm64",
    urls = [
        "https://github.com/cli/cli/releases/download/v2.59.0/gh_2.59.0_macOS_arm64.zip",
    ],
)
