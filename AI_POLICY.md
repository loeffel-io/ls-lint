...
The ls-lint project has strict rules for AI usage:
...
These rules apply only to outside contributions to ls-lint. Maintainers
...
Please remember that ls-lint is maintained by humans.
...
ls-lint is written with plenty of AI assistance, and many maintainers embrace
